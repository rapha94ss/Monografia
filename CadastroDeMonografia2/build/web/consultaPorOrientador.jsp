...
<html>
    ...
    <body>
        <div class="container">
            ...
            <h1>Consulte por orientador</h1>
        <select name="selecao" id="selecao" >
           <option value="0">Escolha um orientador</option>
           <%
               String resp = "";
               try{
                   ResultSet rs = stmt.executeQuery("SELECT * FROM monografias ORDER BY orientador");
                   while(rs.next()){
                       resp+="<option value='"+rs.getInt("id")+"'>";
                       resp+=rs.getString("orientador")+"</option>";
                   }
                   rs.close();
               }catch(Exception ex){
