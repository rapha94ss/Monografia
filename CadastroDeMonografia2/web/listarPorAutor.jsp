<%-- 
    Document   : listarPorAutor
    Created on : 21/11/2016, 00:07:49
    Author     : rapha
--%>
    ...
    <body>
        <div class="container">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="active"><a href="#">Listar por ordem de Autor</a></li>
            ...
            <table class="table table-hover">
                <tr class="rotulo">
                    ...
                    <th>AREA</th><th>ANO</th><th>LOCAL</th><th>RESUMO</th></tr>
                        <%
                            ResultSet res = mono.listarPorAutor();
                            while (res.next()) {
                        %>
                <tr class="dados">
