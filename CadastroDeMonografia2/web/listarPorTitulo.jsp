<%-- 
    Document   : listarPorTitulo
    Created on : 20/11/2016, 23:05:12
    Author     : rapha
--%>
    ...
    <body>
        <div class="container">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li class="active"><a href="listarPorTitulo.jsp">Listar por ordem de Título</a></li>
            ...
            <table class="table table-hover">
                <tr class="rotulo">
                    ...
                    <th>AREA</th><th>ANO</th><th>LOCAL</th><th>RESUMO</th></tr>
                        <%
                            ResultSet res = mono.listarPorTitulo();
                            while (res.next()) {
                        %>
                <tr class="dados">
